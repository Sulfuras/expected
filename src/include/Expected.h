...
namespace std {
    ...
    namespace detail {
        ...
        concept expected_constructible_from_other =
            ...
            ( !std::constructible_from< T, expected< U, G > & > ) &&( !std::constructible_from< T, expected< U, G > > ) &&(
                    ...
                    expected< U, G > const
                        & > ) &&( !std::
                                      constructible_from<
                                          ...
                                          expected<
                                              U,
                                              G > const > ) &&( !std::convertible_to< expected< U, G > &,
                                                                                      T > ) &&( !std::
                                                                                                    convertible_to<
                                                                                                        expected< U, G >
                                                                                                            &&,
                                                                                                        T > ) &&( !std::
                                                                                                                      convertible_to<
                                                                                                                          expected<
                                                                                                                              ...
                                                                                                                              &,
                                                                                                                          T > ) &&( !std::
                                                                                                                                        convertible_to< expected< U, G > const &&, T > ) &&( !std::constructible_from< unexpected< E >, expected< U, G > & > ) &&( !std::constructible_from< unexpected< E >,
                                                                                                                                                                                                                                                                                             expected<
                                                                                                                                                                                                                                                                                                 U,
                                                                                                                                                                                                                                                                                                 G > > ) &&( !std::constructible_from< unexpected< E >,
                                                                                                                                                                                                                                                                                                                                       expected<
                                                                                                                                                                                                                                                                                                                                           U,
                                                                                                                                                                                                                                                                                                                                           G > const & > ) &&( !std::
                                                                                                                                                                                                                                                                                                                                                                   constructible_from<
    ...
    public:
        ...
        constexpr explicit( !std::convertible_to< U const &, T > || !std::convertible_to< G const &, E > )
        ...
        constexpr explicit( !std::convertible_to< G const &, E > ) expected( unexpected< G > const &e )   // NOLINT
                : has_val { false }
        ...
        template< class U = T >
            ...
            ( !detail::is_unexpected< std::remove_cvref_t< U > > ) &&std::constructible_from< T, U >
        ...
        template< class T2, class E2 >
            requires( !std::is_void_v< T2 > ) && requires( T const &t1, T2 const &t2, E const &e1, E2 const &e2 ) {
                {
                    t1 == t2
                } -> std::convertible_to< bool >;
                {
    ...
    public:
        ...
        constexpr explicit( !std::is_convertible_v< G const &, E > ) expected( unexpected< G > const &e )   // NOLINT
                : has_val( false )
                , unex( std::forward< G const & >( e.value() ) )
        {
        }
        ...
        template< class G >
            requires std::is_constructible_v< E, G const & > and std::is_assignable_v< E &, G const & >
        constexpr auto operator=( unexpected< G > const &e ) -> expected &
        {
            if( has_value() ) {
